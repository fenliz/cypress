            ...
            switch (_e.label) {
                ...
                case 14:
                    ...
                    if (os_1.default.platform() === 'win32') {
                        browserInstance.kill = function (_) { return __awaiter(_this, void 0, void 0, function () {
...
exports.open = open;
var killFirefoxInstanceWin32 = function (browserInstance) {
    var instanceKill = "TASKKILL /T /PID " + browserInstance.pid;
    var parentPidFile = browserInstance.spawnargs[browserInstance.spawnargs.length - 1].split('\\');
    var parentPidWithFilename = parentPidFile[parentPidFile.length - 1].split('-');
    var parentPid = parentPidWithFilename[parentPidWithFilename.length - 1];
    var parentKill = "TASKKILL /T /PID " + parentPid;
    exec(instanceKill, { shell: 'cmd.exe' }, function (error, stdout, stderr) {
        ...
        exec(parentKill, { shell: 'cmd.exe' }, function (error, stdout, stderr) {
