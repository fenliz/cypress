(function() {
  var Mocha, Promise, Reporter, STATS, _, createRunnable, createSuite, customReporterMochaPath, debug, events, getParentTitle, mergeErr, mergeRunnable, mochaCreateStatsCollector, mochaReporters, overrideRequire, path, reporters, safelyMergeRunnable, setDate,
    slice = [].slice;
  ...
  overrideRequire = require('./override_require').overrideRequire;
  ...
  overrideRequire(function(depPath, _load) {
